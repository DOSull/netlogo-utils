...
Reports a list of the sum of the remaining values in _list_ at each position, that is &Sigma;<i><sub>i</sub><sup>N</sup> x<sub>i</sub></i> where _N_ is the length of the list, for example:
